...
from reader_side import reader
...
class side_classifier(nn.Module):
    def __init__(self):
        ...
        # encoding_layer = nn.TransformerEncoderLayer(58,1)
        # self.encode = nn.TransformerEncoder(encoding_layer,16)
        
        self.dropout = nn.Dropout(p=0.3)
        self.layer_1 = nn.Linear(in_features=58,out_features=2048)
    ...
    def runAll(self):
        ...
        for i in range(0, self.Epochs):
            ...
            if i % self.eval_every == 0:
                ...
                mat_path = "/home/ephraimpan/football_project/side/confusion_matrix/"
