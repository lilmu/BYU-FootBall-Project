...
class trainer():
    def __init__(self, Path_test_player, Path_test_label, Path_train_player, Path_train_label):
        ...
        self.save_model_path = "./football_project/off30/model/"
        self.save_pic_path = './football_project/off30/pic/'
...
if __name__ == "__main__":
    Path_test_player = Path("./football_data/save_datas/off30/test_data.pt")
    Path_test_label = Path("./football_data/save_datas/off30/test_label.pt")
    Path_train_player = Path("./football_data/save_datas/off30/train_data.pt")
    Path_train_label = Path("./football_data/save_datas/off30/train_label.pt")
