...
from reader_offense30 import reader
...
class trainer():
    def __init__(self, Path_test_player, Path_test_label, Path_train_player, Path_train_label):
        ...
        self.save_model_path = "/home/ephraimpan/football_project/off30/model/"
        self.save_pic_path = '/home/ephraimpan/football_project/off30/pic/'
    ...
    def train_helper(self):
        ...
        for player, label in self.train_dataloader:
           ...
           #get accuracy
            for i in range(label.size(dim=0)):
                    if torch.argmax(label[i])== pred[i]:
                        correct +=1
            acc_total += label.size(dim=0)
    ...
    def runAll(self):
        ...
        for i in range(0, self.Epochs):
            ...
            if i % self.eval_every == 0:
                ...
                mat_path = "/home/ephraimpan/football_project/off30/confusion_matrix/"
...
if __name__ == "__main__":
    Path_test_player = Path("/home/ephraimpan/football_data/save_datas/off30/test_data.pt")
    Path_test_label = Path("/home/ephraimpan/football_data/save_datas/off30/test_label.pt")
    Path_train_player = Path("/home/ephraimpan/football_data/save_datas/off30/train_data.pt")
    Path_train_label = Path("/home/ephraimpan/football_data/save_datas/off30/train_label.pt")
